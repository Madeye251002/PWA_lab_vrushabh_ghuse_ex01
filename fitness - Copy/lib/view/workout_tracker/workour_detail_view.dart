...
class _WorkoutDetailViewState extends State<WorkoutDetailView> {
  ...
  late TimeOfDay selectedTimeOfDay = TimeOfDay.now();
  late String chosenWorkout = "Upperbody";
  ...
  void updateState(Map updatedDetails) {
    setState(() {
      ...
      chosenWorkout = updatedDetails['chosenWorkout'];
      difficulty = updatedDetails['difficulty'];
      customRepetitions = updatedDetails['customRepetitions'];
      customWeights = updatedDetails['customWeights'];
    });
  }
                    ...
                    children: [
                      ...
                      IconTitleNextRow(
                        ...
                        onPressed: () async {
                          ...
                          // Check if there are any details passed from AddScheduleView
                          if (updatedDetails != null) {
                            // Handle the updated details using the updateState method
