...
class WorkoutScheduleView extends StatefulWidget {
  ...
  const WorkoutScheduleView({Key? key, required this.onTimeSelected})
      : super(key: key);
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => AddScheduleView(
                        date: DateTime
                            .now(), // Provide a value for the required parameter date
                        onUpdate: (data) {
                          // Provide a function for the onUpdate parameter
                          // This function should take a Map<dynamic, dynamic> as a parameter
                          // and define what should happen when the data is updated
                          // For example:
